      ...
      <div style={{ width:'100%', background:'var(--bg-surface)', borderRadius:16, border:'1px solid var(--border-subtle)', padding:24 }}>
        {sent ? (
          <div style={{ textAlign:'center' }}>
            ...
            <Link href="/auth/login" style={{ display:'block', textAlign:'center', color:'var(--text-secondary)', fontSize:14 }}>
              ← {t('auth.backToLogin')}
            </Link>
          </div>
        ) : (
          <>
            ...
            <div style={{ textAlign:'center', marginTop:20 }}>
              <Link href="/auth/login" style={{ color:'var(--text-secondary)', fontSize:14 }}>
                ← {t('auth.backToLogin')}
              </Link>
            </div>
          </>
